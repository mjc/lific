...
The interactive password prompt is the default and avoids exposing the password in process listings or shell history. Use `--password` only when a script requires it, and protect the command and its logs accordingly.
