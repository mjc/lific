...
`lific service install` records the executable it starts. After a
`nix profile upgrade`, run it again to update an installed user service before
older profile generations are collected.
